...
of them to the console, along with the number of goals that were scored in total (number of player names passed in)
...
//4
const players1Final = [...players1, 'Thiago', 'Goutino', 'Perisic'];
//5
...
const average = function (odds) {
    ...
    return `Average odd is ${result / odds.length}`;
}
